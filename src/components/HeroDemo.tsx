  ...
  switch (kind) {
    ...
    case "evaluation":
      return (
        <svg viewBox="0 0 24 24" fill="none" aria-hidden>
          <path
            d="M5 5.5h14v13H5zM8 9h8M8 12h5M8 15h7"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinejoin="round"
          />
  ...
  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">A proactive agent for every Scale AI seller</p>
        <h1>The agents that work while your reps sell.</h1>
        <p className="hero-intro">
          Grok Bot watches calls, the inbox, and account changes in the
          background. It starts from work already happening, not another
          prompt.
        </p>
